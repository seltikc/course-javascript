...
const res = returnFirstArgument(10);
const res1 = returnFirstArgument('Привет');
...
const resl = sumWithDefaults(10, 20);
console.log(resl);
const resl1 = sumWithDefaults(2, 4);
console.log(resl1);
const resl2 = sumWithDefaults(0);
console.log(resl2);
...
const control = returnCounter(10);
console.log(control());
